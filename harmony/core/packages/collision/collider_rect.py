...
from harmony.core.packages.collision.collider import Collider, ColliderType
from harmony.core.packages.geometry.transform import transform_rectangle

if TYPE_CHECKING:
    from harmony.core.packages.collision.collision_surface import CollisionSurface
...
class ColliderRect(Collider):
    ...
    @override
    def copy(self) -> ColliderRect:
        """Copy the component."""
        return ColliderRect(self.rect.copy(), self.collision_surface)
