...
from harmony.core.packages.input.controls.device import Device, DeviceType
from harmony.game.event import PygameMouseMoveEvent, PygameMouseStateEvent, PygameMouseWheelEvent

if TYPE_CHECKING:
    from harmony.core.packages.input.input_backend import InputBackend, PygameInputBackend
