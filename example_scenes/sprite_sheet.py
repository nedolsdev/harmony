...
def create_sprite_sheet_scene(window_settings: WindowSettings, layers: SortingLayerManager) -> Scene:
    ...
    grid_obj = (
        ...
        .add_component(Transform(local_position=Vector2(50, 50), local_scale=Vector2(1, 1)))
