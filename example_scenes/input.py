...
def create_input_scene(window_size: int, layers: SortingLayerManager, runner: Runner) -> Scene:
    """Return a Scene configured for testing input behavior."""
    scene = Scene()

    runner.input_system.create_map("gameplay", action_map=create_gameplay_action_map())
